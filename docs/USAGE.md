...
[Project overview](../README.md) | [中文使用指南](USAGE.zh-CN.md)
...
See [key extraction and troubleshooting](KEY_EXTRACTION.md). Permissions and compatibility depend on your macOS and WeChat version.
